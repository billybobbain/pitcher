...
public class TemperatureData {
    ...
    public static String[] DEMO_AXES_LABELS = { "X", "Y" };
    public static String DEMO_CHART_TITLE = "Pitch Location";
    ...
    public static String[] DEMO_TITLES = {"home","away"};//"2","3","4","5","6","7","8","9"}; //, "Corfu", "Thassos", "Skiathos" };
